...
# At this point you may delete unnecessary items from your list
del(fasta1, fasta2)
...
AlignmentReads1_Global = NeedlemanWunsch(A,B)[2]
AlignmentReads2_Global = NeedlemanWunsch(A,B)[4]
ScoreMatrix_Global = NeedlemanWunsch(A,B)[0]
DirectionMatrix_Global = NeedlemanWunsch(A,B)[1]
AlignedSeq_Global = NeedlemanWunsch(A,B)[6]
AlignmentScore_Global = NeedlemanWunsch(A,B)[5]

AlignmentReads1_Local = SmithWaterman(A,B)[2]
AlignmentReads2_Local = SmithWaterman(A,B)[4]
ScoreMatrix_Local = SmithWaterman(A,B)[0]
DirectionMatrix_Local = SmithWaterman(A,B)[1]
AlignedSeq_Local = SmithWaterman(A,B)[6]
AlignmentScore_Local = SmithWaterman(A,B)[5]


AlignedSeq_Global = NeedlemanWunsch(A,B, ScrMtrx = BLOSUM80, SeqType = AASeq)[6]
AlignmentScore_Global = NeedlemanWunsch(A,B, ScrMtrx = BLOSUM80, SeqType = AASeq)[5]

AlignedSeq_Local = SmithWaterman(A,B, ScrMtrx = BLOSUM80, SeqType = AASeq)[6]
AlignmentScore_Local = SmithWaterman(A,B, ScrMtrx = BLOSUM80, SeqType = AASeq)[5]
